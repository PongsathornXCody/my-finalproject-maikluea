...
export function Topup({products, onAddToCart}){
    return(
        <div className="rounded-xl w-[90%] h-[100%] mx-[5%] my-[5%] shadow-lg shadow-teal-200 text-center">
          ...
          <div className="grid grid-cols-2 gap-4 lg:grid-cols-6">
            ...
            <div key={item.id} className="border-4 p-4 rounded-lg shadow-sm bg-white scale-100 hover:scale-105 transform duration-100 cursor-pointer">
              ...
              className="flex bg-gradient-to-r from-green-500 via-green-400 to-green-500  hover:bg-green-300 p-2 rounded-md items-center text-white font-semibold hover:ring-2 ring-blue-600">
                <BsCartCheckFill />Add
              </button>
            </div>
            ))}
